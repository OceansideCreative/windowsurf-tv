...
const STREAMS = [
  { id: 1, title: "Pipeline, North Shore", videoId: "GgGk2EZBQMY", category: "beaches", location: "Oahu, Hawaii", vibe: "intense" },
  { id: 2, title: "Waikiki Beach", videoId: "gCiMtBGOfrQ", category: "beaches", location: "Honolulu, Hawaii", vibe: "chill" },
  { id: 3, title: "Mavericks", videoId: "6heBM4WQNSU", category: "beaches", location: "Half Moon Bay, CA", vibe: "intense" },
  { id: 4, title: "Nazaré Big Waves", videoId: "bRAxnCtw7bE", category: "beaches", location: "Nazaré, Portugal", vibe: "intense" },
  { id: 5, title: "Venice Beach Boardwalk", videoId: "vCsABRKaBEk", category: "beaches", location: "Los Angeles, CA", vibe: "chill" },
  { id: 6, title: "Bondi Beach", videoId: "a6RCsMq67Mo", category: "beaches", location: "Sydney, Australia", vibe: "chill" },
  { id: 7, title: "South Beach Miami", videoId: "MWmaVpaHxGU", category: "beaches", location: "Miami, FL", vibe: "chill" },
  { id: 8, title: "Hollywood Beach", videoId: "KXs_FbQ3fmk", category: "beaches", location: "Hollywood, FL", vibe: "chill" },
  { id: 10, title: "St. Maarten / Maho Beach", videoId: "JUICfYJ4oOI", category: "airports", location: "St. Maarten", vibe: "chaos" },
  { id: 11, title: "LAX Plane Spotting", videoId: "jMf__aOAnGo", category: "airports", location: "Los Angeles, CA", vibe: "chill" },
  { id: 12, title: "Heathrow Airport Live", videoId: "5Ck27AuSsI0", category: "airports", location: "London, UK", vibe: "chill" },
  { id: 13, title: "Tokyo Narita Live", videoId: "prYN5yw-nfM", category: "airports", location: "Tokyo, Japan", vibe: "zen" },
  ...
  { id: 22, title: "Venice Grand Canal", videoId: "zMev3tRYMiI", category: "cities", location: "Venice, Italy", vibe: "chill" },
  { id: 23, title: "Las Vegas Strip", videoId: "nOLMRyFMsBs", category: "cities", location: "Las Vegas, NV", vibe: "chaos" },
  { id: 24, title: "Dublin City Centre", videoId: "S9UqjBBo40M", category: "cities", location: "Dublin, Ireland", vibe: "chill" },
  { id: 25, title: "Amsterdam Canals", videoId: "fzZDMCfGEjI", category: "cities", location: "Amsterdam, Netherlands", vibe: "chill" },
  { id: 30, title: "Africam Watering Hole", videoId: "ydYDqZQpim8", category: "wildlife", location: "South Africa", vibe: "zen" },
  { id: 31, title: "Monterey Bay Jellyfish", videoId: "PK1BD4RYXlI", category: "wildlife", location: "Monterey, CA", vibe: "zen" },
  { id: 32, title: "Sea Otter Cam", videoId: "xdGSVjBxIng", category: "wildlife", location: "Monterey, CA", vibe: "chill" },
  { id: 33, title: "Brown Bears — Katmai", videoId: "wgMdKPNSwIs", category: "wildlife", location: "Katmai, Alaska", vibe: "intense" },
  { id: 34, title: "Bald Eagle Nest", videoId: "rFxDjnxu71Y", category: "wildlife", location: "Decorah, Iowa", vibe: "zen" },
  ...
  { id: 51, title: "Japan Rail Cam", videoId: "wLRRn70sDSE", category: "trains", location: "Japan", vibe: "zen" },
  { id: 52, title: "Panama Canal", videoId: "UsPeGFH8lXo", category: "trains", location: "Panama", vibe: "chill" },
  { id: 60, title: "Iceland Northern Lights", videoId: "6MEmFE1FGzU", category: "weird", location: "Iceland", vibe: "zen" },
  { id: 61, title: "Kilauea Volcano", videoId: "jIUKXWJzftg", category: "weird", location: "Hawaii", vibe: "intense" },
  { id: 62, title: "Riga Street Cam", videoId: "sBVaGb0pf_Q", category: "weird", location: "Riga, Latvia", vibe: "chill" },
];
